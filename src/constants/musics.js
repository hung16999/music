export const musics = [
  {
    ...
    lyric: `Anh phải về trước khi trời nắng
    Không mẹ anh lại mắng
    Đừng đưa cho anh hóa chất lạ
    Đừng bắt anh đưa về chỗ vắng\n \n \n \

    Anh không tìm tình yêu
    Đếm còn không hết không muốn thích em nhưng
    Thấy là đã kết đừng mời anh đừng mời anh
    Ly trước còn chưa hết

    Khỏi nói về nội trợ
    Khỏi nói về tính nết
    Vị trí em là doggy
    Chứ không phải trong bếp

    Gucci túi em xách tay( gucci)
    Ysl trên gót giày ( gót)
    Silent on the phone vì facebook em ring ring suốt ngày
    Bạn em toàn con trai thân

    Nhiều đam mỹ, và doanh nhân
    Em không giống Bích Phương
    Lát nữa em ngã chị em đâu ai nâng

    [Chorus:]
    [Thôi anh hem chơi đâu
    Đừng đưa cho anh
    Thôi anh hem chơi đâu
    Đừng đưa cho anh] x2

    Đừng bắt anh uống cả chai
    Đừng vẽ cho anh cả line
    Đừng bẻ cho anh một nửa
    *** it đưa anh beat và mic

    Ya, 2 chữ S, neva sleep, team của anh
    On top of the game
    3 giờ sáng
    Trong phòng tắm
    ...
    Anh chẳng thấy được gì yeah

    Thôi, đừng mời anh nữa nhá
    Anh còn phải đi về
    Em có thể nằm ở trang đầu

    Kênh 14 hay yeah 1
    Nhưng sẽ úp mặt xuống gối
    Trên ghế phòng khách hay xe anh
  ...
  },
  {
    id: 3,
    name: "Blue",
    lyric: `gyeoul-i gago bom-i chaj-aojyo ulin sideulgo
    ...
    (I'm singing my blues) tteunguleum-e nallyeobonaen salang oh oh
    같은 하늘 다른 곳 너와나 위험하니까 너에게서 떠나주는 거야
    gat-eun haneul daleun gos neowana wiheomhanikka neoegeseo tteonajuneun geoya

    님이란 글자에 점하나 비겁하지만 내가 못나 숨는 거야
    nim-ilan geulja-e jeomhana bigeobhajiman naega mosna sumneun geoya

    잔인한 이별은 사랑의 末路(말로) 그 어떤 말도 위로 될 수는 없다고
    jan-inhan ibyeol-eun salang-ui malno(mallo) geu eotteon maldo wilo doel suneun eobsdago

    아마 내 인생의 마지막 멜로 막이 내려오네요 이제
    ama nae insaeng-ui majimag mello mag-i naelyeooneyo ije
    태어나서 널 만나고 죽을 만큼 사랑하고
    taeeonaseo neol mannago jug-eul mankeum salanghago

    파랗게 물들어 시린 내 마음 눈을 감아도 널 느낄 수 없잖아
    palahge muldeul-eo silin nae ma-eum nun-eul gam-ado neol neukkil su eobsjanh-a
    겨울이 가고 봄이 찾아오죠 우린 시들고
    gyeoul-i gago bom-i chaj-aojyo ulin sideulgo
    ...
    simjang-i meoj-eun geos man gat-a jeonjaeng-i kkeutnago geu gos-e eol-eo but-eun neowana

    내 머릿속 새겨진 Trauma 이 눈물 마르면 촉촉히 기억하리 내 사랑
    nae meolis-sog saegyeojin Trauma i nunmul maleumyeon chogchoghi gieoghali nae salang

    괴롭지도 외롭지도 않아 행복은 다 혼잣말 그 이상에 복잡한 건 못 참아
    goelobjido oelobjido anh-a haengbog-eun da honjasmal geu isang-e bogjabhan geon mos cham-a

    대수롭지 아무렇지도 않아 별수없는 방황 사람들은 왔다 간다
    daesulobji amuleohjido anh-a byeolsueobsneun banghwang salamdeul-eun wassda ganda
    태어나서 널 만나고 죽을 만큼 사랑하고
    taeeonaseo neol mannago jug-eul mankeum salanghago

    파랗게 물들어 시린 내 마음 너는 떠나도 난 그대로 있잖아
    palahge muldeul-eo silin nae ma-eum neoneun tteonado nan geudaelo issjanh-a
    겨울이 가고 봄이 찾아오죠 우린 시들고
    gyeoul-i gago bom-i chaj-aojyo ulin sideulgo
    ...
    oneuldo palan jeo dalbich-alaee na hollo jam-i deulgessjyo

    꿈속에서도 난 그대를 찾아 헤매이며 이 노래를 불러요
    kkumsog-eseodo nan geudaeleul chaj-a hemaeimyeo i nolaeleul bulleoyo
    파란 눈물에 파란 슬픔에 길들여져
    palan nunmul-e palan seulpeum-e gildeul-yeojyeo
    ...
    (I'm singing my blues) palan nunmul-e palan seulpeum-e gildeul-yeojyeo
  ...
  },
  {
    id: 8,
    name: "Happy New Year",
    lyric: `No more champagne and the fireworks are through.
